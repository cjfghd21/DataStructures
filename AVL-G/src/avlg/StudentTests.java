...
public class StudentTests {
    ...
    @Test
    public void testAVL3Unchanged() throws InvalidBalanceException, EmptyTreeException {
        tree = new AVLGTree<>(3);
        tree.insert(20);
        tree.insert(10);
        tree.insert(5);
        tree.insert(2); 
        // no rotation should be done, height should be 3
        assertEquals("In an AVL-1 tree with three descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(20), tree.getRoot());
        assertEquals("In an AVL-1 tree with three descending order integers inserted, " +
    ...
    @Test
    public void testAVLChanged3() throws InvalidBalanceException, EmptyTreeException {
        tree = new AVLGTree<>(3);
        tree.insert(20);
        tree.insert(10);
        tree.insert(5);
        tree.insert(2);
        tree.insert(1); // Should trigger a right rotation about the root.
        assertEquals("In an AVL-3 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(10), tree.getRoot());
        assertEquals("In an AVL-3 tree with four descending order integers inserted, " +
                "the new rc was not the expected one.", Integer.valueOf(5), tree.getLc());
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new height was not the expected one.", 3, tree.getHeight()); // Height of 3 expected
        tree.insert(19);
        tree.insert(22);
        tree.insert(23);
        tree.insert(24);
        ...
        assertEquals("In an AVL-3 tree with four descending order integers inserted, " +
                "the new root was not the expected one.", Integer.valueOf(10), tree.getRoot()); // Root should change to 10
        assertEquals("In an AVL-2 tree with four descending order integers inserted, " +
                "the new height was not the expected one.", 5, tree.getHeight()); // Height of 5 expected
    ...
    @Test
    public void testAVLBalanced() throws InvalidBalanceException, EmptyTreeException {
    	tree = new AVLGTree<>(1);
    	tree.insert(1);
    	tree.insert(3);
    	tree.insert(2);
    	
    	 assertEquals("In an AVL-1 tree " +
                 "the new root was not the expected one.", Integer.valueOf(2), tree.getRoot()); 
         assertEquals("In an AVL-1 tree, lc is not the expected one.", Integer.valueOf(1), tree.getLc());
         assertEquals("In an AVL-1 tree, rc is not the expected one.", Integer.valueOf(3), tree.getRc());
    ...
    @Test
    public void test_Search() throws InvalidBalanceException, EmptyTreeException{
    	tree = new AVLGTree<>(3);
        tree.insert(5);
        tree.insert(2);
        tree.insert(7);
        ...
        assertEquals("17 should be searchable",Integer.valueOf(17) , tree.search(17));
        assertEquals("-100 should be unsearchable",null , tree.search(-100));
    
    }
    
    @Test
    public void testDeleteRotationAVL2() throws InvalidBalanceException, EmptyTreeException{
        tree = new AVLGTree<>(2);
        tree.insert(5);
        tree.insert(2);
        tree.insert(9);
        ...
        assertEquals("In an AVL-2 tree   the tree's new root was not the expected one.",
    			Integer.valueOf(6), tree.getRoot());
        
        assertEquals("In an AVL-2 tree   the tree's new height was not the expected one.",
        			2, tree.getHeight());
        assertEquals("In an AVL-2 tree   the tree's new count was not the expected one.",
    			5, tree.getCount());
