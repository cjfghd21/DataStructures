...
public class StudentTests {
    ...
    @Test
    public void testOrderedProbes() {

    	OrderedLinearProbingHashTable lp = new OrderedLinearProbingHashTable(false);

        assertEquals(1, lp.put("8", "894-59-0011").getProbes());
        assertEquals(1, lp.put("9", "894-59-0011").getProbes());
        assertEquals(1, lp.put("3", "705-12-7500").getProbes());
        assertEquals(4, lp.put("1", "888-1212-3340").getProbes());
